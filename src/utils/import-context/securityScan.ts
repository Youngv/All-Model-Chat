...
const buildPreview = (match: string): string => (match.length > 80 ? `${match.slice(0, 77)}...` : match);
...
export const scanSensitiveContent = (filePath: string, content: string): SecurityFinding[] => {
